...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/home/natepidl/Downloads/SNU-Subjects/GCN/FinalProject/kinetics700')
    parser.add_argument(
        '--out_folder', default='/home/natepidl/Downloads/SNU-Subjects/GCN/FinalProject/GCN-NAS/Output/kinetics/')
    arg = parser.parse_args()

    part = ['train']#['val', 'train']
    for p in part:
        print('kinetics ', p)
